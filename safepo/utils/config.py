...
isaac_gym_map = {
    ...
    # "ShadowHandOver_Safe_finger_2constraints": "shadow_hand_over_safe_finger",
...
def single_agent_args():
    custom_parameters = [
        ...
        {"name": "--task", "type": str, "default": "ShadowHandOver_Safe_finger", "help": "The task to run"}, # FreightFrankaCloseDrawer SafetyPointGoal1-v0
        ...
        {"name": "--headless", "type": lambda x: bool(strtobool(x)), "default": True, "help": "Toggles headless mode"},
        ...
        # {"name": "--cost-limit", "type": float, "default": 0.5, "help": "cost_lim"},
        {"name": "--cost1-limit", "type": float, "default": 0.5, "help": "cost_lim"},
        {"name": "--cost2-limit", "type": float, "default": 0.5, "help": "cost_lim"},
